...
|---|---|---|---|
| 战略与价值验证 | 机会、问题线索、资源约束 | 用户问题、价值假设、市场和风险 | 继续/调整/停止决定，成功指标 |
...
| 风险或问题 | 影响 | 临时处理 | 决策人 | 截止条件 |
|---|---|---|---|---|
| API 认证方式未定 | 阻塞接口实现 | 仅完成领域模型 | 架构责任人 | 进入任务执行前 |

未决事项不得以“后续再看”进入下一阶段，必须说明是否阻塞、谁决定和最晚何时解决。
...
## 5. 与任务 Context Pack 的关系

```text
项目 Context Pack
        ↓
阶段 Context：确定本阶段目标、产物和门禁
        ↓
任务 Context Pack：确定一次任务的范围、契约和验证
        ↓
执行结果、证据和经验
        ↓
更新阶段状态与项目长期事实
