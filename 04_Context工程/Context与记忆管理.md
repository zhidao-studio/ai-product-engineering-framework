...
本框架把这个原则扩展到完整产品生命周期：AI 不仅需要理解代码，还需要理解产品价值、用户体验、高保真确认、业务规则、架构契约、任务边界、验证证据和历史决策。
...
flowchart TB
    ...
    C2[项目级 Context<br/>产品、业务、设计、架构、契约、环境]
    C3[阶段级 Context<br/>阶段目标、输入、产物、门禁、责任]
...
| 概念 | 定义 | 是否权威事实源 |
|---|---|---|
| Context 事实源 | 产品、设计、工程、决策、契约等长期资产 | 是，按状态和优先级确定 |
