...
> 本文定义 AI 产品工程框架不可被局部实现、具体工具或短期任务破坏的基本原则。后续的 Context、Harness、Skills、Agents、Loop、模板、门禁和参考工程都必须能够说明自己如何遵守这些原则。
