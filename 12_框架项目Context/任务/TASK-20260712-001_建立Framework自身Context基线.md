...
> **历史快照：** 本任务记录 Framework 首次自应用 Context 时的基线、范围和结论。文件中的 v0.1.1、许可证待决项和下一步只反映当时状态；当前稳定版本、工作段、阻塞和下一步以 [Framework 项目 Context](../README.md)、[CHANGELOG](../../CHANGELOG.md) 和 [Roadmap](../../10_版本演进/Roadmap.md) 为准。
...
> “契约”是本历史任务形成时的原始术语。当前中文主要表述使用“约定”。
...
> “门禁”是本历史任务形成时的原始术语。当前中文主要表述使用“检查关卡”。
...
> 93/100 是当时自应用基线评分，不代表 v0.1.5 当前全仓评分。
...
> 最后一项已在 v0.1.2 由专有 LICENSE 和 DEC-009 解决。当前未解决事项与下一步以 [Framework 项目 Context](../README.md) 为准。
