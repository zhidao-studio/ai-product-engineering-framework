...
| 平台体验责任人 | 确认共享体验如何映射到目标客户端 | 是否接受平台差异和原生交互选择 |
...
| 视觉与设计系统 Agent | 品牌、Design Tokens、组件语义、内容和视觉层级 | 产品设计系统与页面视觉规范 |
| 平台体验与原型 Agent | 将共享体验映射到 iOS、Android、桌面、Web 或 H5 | 平台适配矩阵和平台高保真 |
